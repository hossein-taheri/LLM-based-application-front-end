  ...
  <q-page class="main_page row">
    ...
    <q-card
      ...
      <div class="human-body parts_selector_images">
        ...
        <svg
          @click="partClicked('left-shoulder')"
          data-position='left-shoulder' id='left-shoulder' class='left-shoulder' xmlns='http://www.w3.org/2000/svg'
        ...
        <svg
          @click="partClicked('right-shoulder')"
          data-position='right-shoulder' id='right-shoulder' class='right-shoulder'
        ...
        <svg
          @click="partClicked('left-arm')"
          data-position='left-arm' id='left-arm' class='left-arm' xmlns='http://www.w3.org/2000/svg' width='156.344'
        ...
        <svg
          @click="partClicked('right-arm')"
          data-position='right-arm' id='right-arm' class='right-arm' xmlns='http://www.w3.org/2000/svg'
        ...
        <svg
          @click="partClicked('chest')"
          data-position='chest' id='chest' class='chest' xmlns='http://www.w3.org/2000/svg' width='86.594'
        ...
        <svg
          @click="partClicked('stomach')"
          data-position='stomach' id='stomach' class='stomach' xmlns='http://www.w3.org/2000/svg' width='75.25'
        ...
        <svg
          @click="partClicked('left-leg')"
          data-position='left-leg' id='left-leg' class='left-leg' xmlns='http://www.w3.org/2000/svg' width='93.626'
        ...
        <svg
          @click="partClicked('right-leg')"
          data-position='right-leg' id='right-leg' class='right-leg' xmlns='http://www.w3.org/2000/svg' width='80'
        ...
        <svg
          @click="partClicked('left-hand')"
          data-position='left-hand' id='left-hand' class='left-hand' xmlns='http://www.w3.org/2000/svg' width='90'
        ...
        <svg
          @click="partClicked('right-hand')"
          data-position='right-hand' id='right-hand' class='right-hand' xmlns='http://www.w3.org/2000/svg' width='90'
          height='38.938' viewBox='0 0 90 38.938'>
          <path
        ...
        <svg
          @click="partClicked('left-foot')"
          data-position='left-foot' id='left-foot' class='left-foot' xmlns='http://www.w3.org/2000/svg' width='30'
        ...
        <svg
          @click="partClicked('right-foot')"
          data-position='right-foot' id='right-foot' class='right-foot' xmlns='http://www.w3.org/2000/svg' width='90'
          height='38.938' viewBox='0 0 90 38.938'>
          <path
